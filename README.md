...
Documentação do projeto, onde vamos contextualizar o contexto do nosso négocio, o objetivo que estamos desenvolvendo essa aplicação, além da justificativa para evidenciar o motivo para desenvolver a aplicação. O escopo com as diretrizes dentre os requisitos que exigemos para ser elaborado, dentre isso teremos as premissas e restrições que colocamos no projeto

Documentação do projeto construida para a o segundo semestre de 2023 da faculdade SPTECH.
